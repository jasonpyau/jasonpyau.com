...
public class CacheUtil {
    ...
    @CacheEvict(cacheNames = {SKILL_CACHE, SKILL_ICON_SVG_CACHE, PROJECT_CACHE, EXPERIENCE_CACHE, ABOUT_ME_CACHE, LINK_CACHE}, allEntries = true)
    public void clearCache() {
        System.out.printf("%s: Cleared skill, skill icon svg, project, experience, about me, and link caches.\n", DateFormat.MMddyyyyhhmmss());
